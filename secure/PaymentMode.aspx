<%@ Page Title="" Language="C#" MasterPageFile="~/secure/Site.master" AutoEventWireup="true" CodeFile="PaymentMode.aspx.cs" Inherits="secure_PaymentMode" %>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Payment Type</h4>
              </div>
              <div class="modal-body">
                 <table width="100%">
                  <tr>
                     <td>Payment Type</td>
                     <td><asp:TextBox ID="txtyear" placeholder="Payment type" CssClass="form-control" runat="server" required></asp:TextBox>  </td>
                  </tr>
                 </table>
              </div>
