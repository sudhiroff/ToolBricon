<%@ Page Title="" Language="C#" MasterPageFile="~/secure/Site.master" AutoEventWireup="true" CodeFile="Currency.aspx.cs" Inherits="secure_Currency" %>
...
<asp:UpdatePanel ID="uppanel" runat="server"><ContentTemplate>
    ...
    <!-- /.col-lg-12 -->
    <div class="col-lg-12">
       <asp:GridView ID="grid" runat="server" Width="50%" 
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                 <table width="100%">
                  <tr>
                     <td>Currency Name</td>
                     <td><asp:TextBox ID="txtCurrency" placeholder="Currency" runat="server" required></asp:TextBox>  </td>
                  </tr>
                 </table>
              </div>
